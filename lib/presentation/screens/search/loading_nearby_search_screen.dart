...
import 'package:cliente/presentation/screens/search/selection_vehicle_screen.dart';
  ...
  Future<void> _fetchAllDataWithSetState() async {
    try {
      ...
      if (distance != null && distance! <= 0.1) {
        setState(() {
          _errorMessage = 'Distance is too short (≤ 0.1 km). Please select a farther drop-off location.';
        });
        return;
      }
